 ...
 public:
  ...
  virtual void Forward(const OpContext &ctx,
    ...
    case activation::None:
    	//LOG(INFO)<<"cudnn activation quantify of none";
    	break;
    case activation::TwoBit:
    	Assign(out, req[activation::kOut], mshadow::expr::F<mshadow_op::twobit>(out));
    	break;
    case activation::FourBit:
        Assign(out, req[activation::kOut], mshadow::expr::F<mshadow_op::fourbit>(out));
        //LOG(INFO)<<"cudnn activation quantify of fourbit";
        break;
    }
  }
