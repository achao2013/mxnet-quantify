...
// trunc
MXNET_REGISTER_SIMPLE_OP(trunc, XPU)
.set_function(XPU::kDevMask, UnaryForward_<XPU, mshadow_op::trunc>, kInplaceInOut)
.set_gradient(XPU::kDevMask, UnaryBackwardUseIn_<XPU, mshadow_op::trunc_grad>, kInplaceOutIn)
.describe("Take truncate value of the src");
}  // namespace op
}  // namespace mxnet
