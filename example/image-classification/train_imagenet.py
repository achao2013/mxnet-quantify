...
parser.add_argument('--clip-weight', type=float,
                    help='clip min/max weight to prevent extreme value')
parser.add_argument('--noclip-weight-layer', type=str, default='0',
                    help='no clip weight layer')
parser.add_argument('--binary-regula', type=str,
                    help='binary regulazation')
parser.add_argument('--no-binary-regula-layer', type=str, default='0',
                    help='no bianry regulazation layer')                    
...
parser.add_argument('--train-dataset', type=str, default="ilsvrc2012_train.rec",
                    help='train dataset name')
parser.add_argument('--val-dataset', type=str, default="ilsvrc2012_val.rec",
